...
* [v1.16 Release Calendar](http://bit.ly/k8s116-cal)
...
- **Thursday, September 5, EOD PST**  - Code Freeze 
- **Monday, September 16** - Docs must be completed and reviewed 
- **Monday, September 23** - Kubernetes 1.16.0 Released 
...
* All Enhancements must have a KEP that is in an implementable state by enhancement freeze.  If the enhancement does not have a KEP in an implementable state by enhancement freeze it will be removed from the milestone and will require an exception.  
* No code slush
...
| **Begin [Enhancements Freeze]** (EOD PST) | Enhancements Lead | Tue 30 | | | week 5 | [master-blocking], [master-upgrade] |
...
| Brace Yourself, Code Freeze is Coming | Comms | | Mon 19 | | | |
...
[k8s116-calendar]: http://bit.ly/k8s116-cal 
